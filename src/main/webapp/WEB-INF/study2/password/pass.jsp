  ...
  <script>
  	...
  	function  fCheck(idx) {
			...
			if(pwd.trim()==""){
				...
				if(idx==1){
					myform.idx.value="1";
					myform.action="${ctp}/study2/passOk1.st";
				}
				else if(idx==2){
					myform.idx.value="2";
					myform.action ="${ctp}/study2/passOk1.st";
					...
					myform.action ="${ctp}/study2/passOk2.st";
					
				}
/* 				document.getElementById("demo").innerHTML="<font color='red'><b>콘솔창을 확인하세요<./b></font><br/>";
				document.getElementById("demo2").innerText="<a href='${ctp}/pass.st' class='btn btn-warning'>돌아가기</a>"; */
				myform.submit();
			}
	}
