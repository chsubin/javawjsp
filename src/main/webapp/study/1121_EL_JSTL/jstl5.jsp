...
<div class="container">
	...
	<p>
		...
		1-1. 천단위마다 콤마 표시 : <fmt:formatNumber value="12345678"/><br/>
<%
	int won=7654321;
...
%>
		...
		<br/>
		<h2>formatDate 형식을 지정한 출력</h2>
		<p>자바 형식의 날짜를 jstl 변수에 저장 : <c:set var="now" value="<%= new java.util.Date() %>"/></p>
		<p>
			오늘 날짜 : ${now}<br/>
		...
		<p>
			...
			톰캣 서버의 기본 로케일(미국식변환) : <fmt:setLocale value="en_US"/> <br/>
		...
		<p>절대경로 : 그림1 <img src="${ctp}/images/1.jpg"/></p>
		<p>URL문 : 그림2 <c:url var="img" value="${ctp}/images/1.jpg"></c:url> <img src="${ctp}/images/1.jpg"/>
