...
<%
	...
	int []num2 = {10,2,4,4,50};
	pageContext.setAttribute("num2", num1);
%>
	...
	11. num1[1] le num2[1] : ${num1[1] le num2[1]}<br/>
	<hr/>
<%
...
%>
	...
	<c:forEach var="vo" items="${arrVos}" varStatus="st"> <!-- request에 담아 온 객체를 사용~~ -->
		${st.count}. ${vo}<br/>
	</c:forEach>
	<hr/>
<% 
...
%>
	...
	<hr/>
<%
	pageContext.setAttribute("var1", "null값 처리");
