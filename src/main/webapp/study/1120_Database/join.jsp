...
<script>
	...
	function fCheck(){
		...
		if(mid.trim()==""){
			alert("아이디를 입력하세요.")
			document.getElementById("mid").focuse();
		}
		...
		<table class="table">
			...
			<tr>
				<td colspan="2" style="text-align:center">
					...
					<input type="reset" value="다시입력" class="btn btn-danger mr-3"/>
					<input type="button" value="돌아가기" onclick="location.href='${pageContext.request.contextPath}/study/1120_Database/login.jsp';" class="btn btn-warning"/>
				</td>
			</tr>
		</table>
	</form>
